    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="client-list.php">Payment History</a>
        </li>
...
if(findCustomer($_SESSION['user_id'],$mysqli,'payment_transaction','customer_id') > 0){

  $date = getMaxDueDate($cid,$mysqli,'payment_transaction','customer_id');
}
//$date = '2018-08-26';
?>
<style type="text/css">
        ...
        <div class="col-lg-8">
          <div class="card mb-3">
            ...
            <div class="card-body">
               ...
               <i>Deadline of your payment is marked red in the calendar</i>
                <?php 
...
<script type="text/javascript">
    ...
    $(".menu-payment-history").addClass("active");
});
</script>