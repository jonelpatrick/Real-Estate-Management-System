  ...
  <div id="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="btn-container">  
        <button class="btn btn-primary" data-toggle="modal" data-target="#addnewcustomer">Add New Customer</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php
                    $sql = "SELECT id,firstname,middlename,lastname,email_address,status FROM customer WHERE deleted= 0";
                     $result = mysqli_query($mysqli,$sql);
                      if (mysqli_num_rows($result) > 0) { 
                         while($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo '<td style="width:15px;"><button class="toolbar-edit" onclick="showEditCustomer('.$id.');" > <i class="far fa-edit"></i>'.''.'</button></td>';
                          echo '<td style="width:15px;"><button class="toolbar-delete" onclick="showDeleteCustomer('.$id.');" ><i class="fa fa-trash" aria-hidden="true"></i>'.''.'</button</td>';
                          echo '</tr>';
                         }
                      }
                  ?>
...
<!-- modal -->
<div class="modal fade firstmodal" id="addnewcustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalLabel">New Customer</h5>
...
<script type="text/javascript">
  ...
  function transactionValidate(){
   ...
   $(function() {
    ...
    $(".menu-customer-list").addClass("active");
});
