    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="client-list.php">Property Sold</a>
        </li>
                ...
                <table class="table table-bordered table-property" id="dataTable" width="100%" cellspacing="0">
                  ...
                  //availability true = sold
                     $sql = "SELECT 
                        ...
                        AND property.client_id = '$client_id'";
                     ...
                     $result = mysqli_query($mysqli,$sql);
                      if (mysqli_num_rows($result) > 0) { 
                         ...
                         while($row = mysqli_fetch_assoc($result)) {
                          ...
                          if($image_path != ""){
                            echo '<img src="../../property-gallery/'.$image_path.'" style="width: 150px; height: 140px;">';
                          }else{
                          ...
                          echo ' <span>Price: </span> <span class="price price2">'.$row['price_bought'].'</span><br>';
                           echo ' <span>status: </span> <span class=""> Sold transferred Property</span><br>';
                          echo "</td>";
...
<script type="text/javascript">
   $(function() {
    ...
    $(".menu-client-property-sold").addClass("active");
  });
</script>