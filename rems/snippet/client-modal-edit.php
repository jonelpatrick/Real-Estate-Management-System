...
$sql = "SELECT firstname,middlename,lastname,age,gender,physical_address,email_address,contact_number,image_path,account_id,status FROM client WHERE id = '$id'";
